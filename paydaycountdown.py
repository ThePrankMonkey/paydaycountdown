...
class HolidayEZ():
    ...
    :param _str_ name: The name of the holiday.
    :param _int_ month: The month that the holiday occurs in (1-12).
    :param _int_ day: The day that the holiday occurs on.
    :param _int_ year: The year that the holiday occurs in (defaults to current year).
    :param _bool_ observed: Dictates whether the holiday is shifted to the nearest work day.
    """
...
class HolidayHard(HolidayEZ):
    ...
    :param _str_ name: The name of the holiday.
    :param _int_ month: The month that the holiday occurs in (1-12).
    :param _int_ weekday: The weekday that the holiday occurs on (0-6,SAT-FRI).
    :param _int_ ordinal: Which occurence of the weekday the holiday occurs on.
    :param _int_ year: The year that the holiday occurs in (defaults to current year).
    """
...
def build_holidays(year=datetime.date.today().year):
    ...
    :param _int_ year: The year you want to find holidays for (defaults to current year).
...
def get_real_pay_dates(today, offset=0):
    ...
    :param _datetime_ today: The current day (used for year and month).
    :param _int_ offset: Used for incrementing to the next month.
...
def build_calendar(cal_year):
    ...
    :param _int_ cal_year: The year you want the holiday to be.
    """
...
if __name__ == "__main__":
    find_next_days()
    build_calendar(cal_year=datetime.datetime.now().year)
